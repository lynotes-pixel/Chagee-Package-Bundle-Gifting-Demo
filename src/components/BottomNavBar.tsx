...
export const BottomNavBar: React.FC<BottomNavBarProps> = ({
  ...
  return (
    <nav
      ...
      className="w-full shrink-0 bg-white/95 backdrop-blur-md border-t border-neutral-200/80 z-20 shadow-[0_-2px_12px_rgba(0,0,0,0.03)] select-none"
    >
      <div className="py-2 px-6 flex items-center justify-around">
        {/* 1. HOME */}
        <button
          id="nav-tab-home"
      ...
      {/* Embedded home indicator pill for mobile frame aesthetic */}
      {isPhoneFrame && (
        <div className="w-full flex justify-center pb-2 pt-0.5 pointer-events-none">
          <div className="w-32 h-1 bg-neutral-900/25 rounded-full" />
        </div>
      )}
    </nav>
  );
